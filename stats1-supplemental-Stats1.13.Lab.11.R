...
wm = read.table("/Users/karenyang/Desktop/StatisticsOne12weeks/stats1-datafiles-Stats1.13.Lab.11.txt", header = T)
...
Levene Test for Homogeneity of Variance (center = "mean")
      Df F value Pr(>F)
...
Kruskal-Wallis chi-squared = 50.2453, df = 3, p-value = 7.084e-11
